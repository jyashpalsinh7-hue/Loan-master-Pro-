...
target = """                    ParamRow(cardData.param1Label, cardData.param1Value)
                    ParamRow(cardData.param2Label, cardData.param2Value)
                    ParamRow(cardData.param3Label, cardData.param3Value)"""

replacement = """                    ParamRowInternal(cardData.param1Label, cardData.param1Value)
...
content = content.replace("@Composable\nfun ParamRow(label: String, value: String) {", "@Composable\nfun ParamRowInternal(label: String, value: String) {")
