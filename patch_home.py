...
filename = '/app/applet/app/src/main/java/com/loanmaster/pro/feature/home/HomeScreen.kt'
with open(filename, 'r') as f:
    content = f.read()

target1 = """    val dummyCurrency = com.loanmaster.pro.LocalCurrency.current
    var showUnlockDialog by rememberSaveable { mutableStateOf(false) }"""

replacement1 = """    val dummyCurrency = com.loanmaster.pro.LocalCurrency.current
...
target3 = """fun SearchAndPremiumRow(searchQuery: String, onSearchQueryChange: (String) -> Unit, onPremiumClick: () -> Unit = {}) {"""

replacement3 = """fun SearchAndPremiumRow(searchQuery: String, onSearchQueryChange: (String) -> Unit, onPremiumClick: () -> Unit = {}, isPremiumUnlocked: Boolean = false) {"""
